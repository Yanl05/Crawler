...
# 一些备选问候语
greetList = ['快去睡觉别熬夜','好好学习加油','注意身体多喝热水','想你了求自拍']
def tick():
    users = itchat.search_friends(name=u'MEIKO') # 找到你女朋友的名称
    userName = users[0]['UserName']
    meetDate = dt.date(2015, 1, 9)  # 这是你跟你女朋友相识的日期
    ...
    nextTickTime = nextTickTime.strftime("%Y-%m-%d 10:28:00")
...
if __name__ == '__main__':
    ...
    nextTickTime = nextTickTime.strftime("%Y-%m-%d 10:28:00") # 把下一个问候时间设定为明天的零点
